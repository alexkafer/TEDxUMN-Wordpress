							...
							<div class="col-md-12">
								<div class="media-area">
									...
									if ( 1 === $comments_number ) {
										...
										printf( _x( 'One thought on &ldquo;%s&rdquo;', 'comments title', 'hestia-pro' ), get_the_title() );
									} else {
										printf(
								...
								<?php if ( ! comments_open() && get_comments_number() ) : ?>
									<?php if ( is_single() ) : ?>
										<h4 class="no-comments title text-center"><?php esc_html_e( 'Comments are closed.' , 'hestia-pro' ); ?></h4>
									<?php endif; ?>
								<?php endif; ?>
								</div>
							</div>
