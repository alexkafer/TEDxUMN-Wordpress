												...
												if ( ! empty( $icons_decoded ) ) :
													...
													<div class="footer">
														<?php foreach ( $icons_decoded as $value ) :
															$social_icon = ! empty( $value['icon'] ) ? apply_filters( 'hestia_translate_single_string', $value['icon'], 'Team section', 'Social Icon' ) : '';
															$social_link = ! empty( $value['link'] ) ? apply_filters( 'hestia_translate_single_string', $value['link'], 'Team section', 'Social Link' ) : '';
															?>
