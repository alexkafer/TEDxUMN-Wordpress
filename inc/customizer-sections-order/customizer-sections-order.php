...
function hestia_sections_live_preview() {
	wp_enqueue_script( 'hestia_sections_live_preview', get_template_directory_uri() . '/inc/customizer-sections-order/js/customizer-sections-live-preview.js', array( 'jquery', 'customize-preview' ), '1.0.0', true );
}
